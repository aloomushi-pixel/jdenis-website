...
export default function VariantManager({
    ...
    return (
        <div className="space-y-6">
            {/* Toast Notification */}
            {toast && (
                <div className={`fixed top-4 right-4 z-50 px-4 py-2 rounded-lg shadow-md text-white text-xs font-medium animate-pulse ${toast.type === 'success' ? 'bg-green-600' : 'bg-red-600'} `}>
                    {toast.msg}
                </div>
            )}
                                                    ...
                                                    <div className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                                                        {products
                                                            ...
                                                            .map(p => (
                                                                <div
                                                                    key={p.id}
                                                                    className="px-4 py-2 cursor-pointer hover:bg-indigo-50 text-sm border-b border-gray-50 last:border-0"
                                                                    onClick={() => {
