...
export default function AdminDashboard() {
    ...
    const topCards = [
        { title: 'Ventas Mensuales', value: `$${metrics.monthlySales.toLocaleString()}`, icon: <I d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />, color: 'bg-green-100 text-green-600', link: '/admin/sales', roles: ['ADMIN', 'EJECUTIVO'] },
    ...
    const quickActions = [
        ...
        { label: 'Nuevo Pedido Venta', icon: <I d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />, path: '/admin/sales', roles: ['ADMIN', 'EJECUTIVO'] },
        { label: 'Gestionar Academia', icon: <I d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5zm0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5" />, path: '/admin/academy', roles: ['ADMIN', 'EJECUTIVO'] },
        { label: 'Gestionar Blog', icon: <I d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />, path: '/admin/blog', roles: ['ADMIN', 'EJECUTIVO'] },
        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                */}
                ...
                {['ADMIN', 'EJECUTIVO', 'FABRICA'].includes(userRole) && (
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            {b2bCards.map((card, i) => (
                                <div key={i} className={`text-center p-4 bg-gray-50 rounded-lg ${!['ADMIN', 'EJECUTIVO', 'FABRICA'].includes(userRole) ? 'hidden' : ''}`}>
