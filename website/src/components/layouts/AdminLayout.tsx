...
const menuItems: MenuItem[] = [
    { path: '/admin', label: 'Dashboard', icon: <I d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6" />, roles: ['ADMIN', 'EJECUTIVO', 'FABRICA', 'ALMACEN_MATERIA_PRIMA', 'ALMACEN_PRODUCTO_FINAL', 'TRANSPORTISTA'] },
    ...
    { path: '/admin/emails', label: 'Emails (Marketing)', icon: <I d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />, roles: ['ADMIN', 'EJECUTIVO'] },
    // === OCULTOS TEMPORALMENTE — próximamente se habilitarán ===
    // { path: '/admin/resources', label: 'Recursos', icon: <I d="..." />, roles: ['EJECUTIVO', 'ALMACEN_MATERIA_PRIMA', 'ALMACEN_PRODUCTO_FINAL'] },
    // { path: '/admin/production', label: 'Fábrica', icon: <I d="..." />, roles: ['FABRICA'] },
    // { path: '/admin/purchases', label: 'Compras', icon: <I d="..." />, roles: ['FABRICA'] }, // OCULTO TEMPORALMENTE
    { path: '/admin/sales', label: 'Ventas', icon: <I d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />, roles: ['EJECUTIVO'] },
    // { path: '/admin/transport', label: 'Transporte', icon: <I d="..." />, roles: ['TRANSPORTISTA', 'EJECUTIVO'] },
    { path: '/admin/packaging', label: 'Embalaje', icon: <I d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25z" />, roles: ['FABRICA', 'ALMACEN_MATERIA_PRIMA', 'ALMACEN_PRODUCTO_FINAL'] },
    { path: '/admin/warehouse-queue', label: 'Cola de Envíos', icon: <I d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" />, roles: ['FABRICA', 'ALMACEN_MATERIA_PRIMA', 'ALMACEN_PRODUCTO_FINAL'] },
    // { path: '/admin/event-log', label: 'Log de Eventos', icon: <I d="..." />, roles: ['EJECUTIVO'] },
    // === FIN OCULTOS TEMPORALMENTE ===

    { path: '/admin/orders', label: 'Pedidos B2B', icon: <I d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />, roles: ['EJECUTIVO', 'FABRICA'] },
    { path: '/admin/reviews', label: 'Reseñas', icon: <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" /></svg>, roles: ['ADMIN', 'EJECUTIVO'] },
    ...
    { path: '/admin/media', label: 'Multimedia', icon: <I d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />, roles: ['ADMIN', 'EJECUTIVO'] },
    ...
    { path: '/admin/facturacion', label: 'Facturación', icon: <I d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />, roles: ['ADMIN', 'EJECUTIVO'] },
    { path: '/admin/catalog', label: 'Editor Catálogo', icon: <I d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125M3.375 19.5h7.5c.621 0 1.125-.504 1.125-1.125M3.375 19.5c-.621 0-1.125-.504-1.125-1.125M19.5 19.5h1.125c.621 0 1.125-.504 1.125-1.125M19.5 19.5c.621 0 1.125-.504 1.125-1.125m0 0V5.625m0 12.75c0 .621-.504 1.125-1.125 1.125m1.125-1.125V5.625M2.25 5.625c0-.621.504-1.125 1.125-1.125h17.25c.621 0 1.125.504 1.125 1.125m-20.625 0v12.75c0 .621.504 1.125 1.125 1.125M2.25 5.625v1.5c0 .621.504 1.125 1.125 1.125m0 0h17.25m-17.25 0c-.621 0-1.125-.504-1.125-1.125M18.375 8.25c.621 0 1.125-.504 1.125-1.125M18.375 8.25h-16.5M18.375 8.25c-.621 0-1.125-.504-1.125-1.125" />, roles: ['ADMIN', 'EJECUTIVO'] },
    ...
    { path: '/admin/coupons', label: 'Cupones', icon: <I d="M9 14.25l6-6m4.5-3.493V21.75l-3.75-1.5-3.75 1.5-3.75-1.5-3.75 1.5V4.757c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0111.186 0c1.1.128 1.907 1.077 1.907 2.185zM9.75 9h.008v.008H9.75V9zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM14.25 9h.008v.008h-.008V9zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />, roles: ['ADMIN', 'EJECUTIVO'] },
];
        ...
        <div className="flex h-screen bg-gray-100 font-sans">
            ...
            >
                ...
                <div className="p-4 border-t border-gray-100 space-y-2">
                    ...
                    >
                        <span className="w-5 h-5 flex-shrink-0"><I d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></span>
